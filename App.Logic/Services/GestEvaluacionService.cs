...
namespace App.logic.Services
{
    public class GestEvaluacionService : IGestEvaluacionService
    {
        ...
        public async Task<GetGestEvaluacionModels> GetGestEvaluacion(long EvaluacionId, int EmpresaId)
        {
            ...
            ObjResult.TextosFormularios = await _txtFormEvaluacionRepository.ListTxtFormEvaluacion(EmpresaId, (int)ObjResult.ObjEvaluacion.InAno, (int)ObjResult.ObjEvaluacion.TipoValoracionId);
            return ObjResult;
        }
