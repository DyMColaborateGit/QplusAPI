...
namespace Qplus.Controllers
{
    ...
    public class ProgramacionMasivaEvaluacionesController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpGet("GetDataProgramacionByID/{IdProgramacion}")]
        public async Task<GetResponse<ResponseTbl_com_ProgramacionMasivaEvaluacionesModels>> GetDataProgramacionByID(int IdProgramacion)
        {
            GetResponse<ResponseTbl_com_ProgramacionMasivaEvaluacionesModels> resultado = new GetResponse<ResponseTbl_com_ProgramacionMasivaEvaluacionesModels>();
            try
            {
                resultado.Data = await _programacionMasivaEvaluacionesService.GetDataProgramacionByID(IdProgramacion);
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
            }
