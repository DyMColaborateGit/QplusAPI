...
namespace Qplus.Controllers
{
    ...
    public class ProductosController : ControllerBase
    {
        ...
        [HttpGet("GetListaSubProcesosByActivos")]
        public async Task<GetResponse<List<ProductosModels>>> GetListaSubProcesosByActivos()
        {
            GetResponse<List<ProductosModels>> resultado = new GetResponse<List<ProductosModels>>();
            try
            {
                resultado.Data = await _productosService.GetListaSubProcesosByActivos();
