...
namespace Qplus.Controllers
{
    ...
    public class ParametrosValoracionController
    {
        ...
        [HttpGet("GetListaParametrosValoracion")]
        public async Task<GetResponse<List<Tbl_rgp_ParametrosValoracionModels>>> GetListaParametrosValoracion()
        {
            GetResponse<List<Tbl_rgp_ParametrosValoracionModels>> resultado = new GetResponse<List<Tbl_rgp_ParametrosValoracionModels>>();
            try
            {
                resultado.Data = await _parametrosValoracionService.GetListaParametrosValoracion();
