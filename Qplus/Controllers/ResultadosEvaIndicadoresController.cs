...
namespace Qplus.Controllers
{
    ...
    public class ResultadosEvaIndicadoresController : ControllerBase
    {
        ...
        [HttpGet("GetListaEvaluacionIndicadoresEstrategicosEvaluacionId/{EvaluacionId}")]
        public async Task<GetResponse<List<JOINTbl_com_ResultadosEvaIndicadoresModels>>> GetListaEvaluacionIndicadoresEstrategicosEvaluacionId(int EvaluacionId)
        {
            ...
            try
            {
                resultado.Data = await _resultadosEvaIndicadoresService.GetListaEvaluacionIndicadoresEstrategicosEvaluacionId(EvaluacionId);
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpGet("GetListaEvaluacionIndicadoresByEvaluacionId/{EvaluacionId}")]
        public async Task<GetResponse<List<JOINTbl_com_ResultadosEvaIndicadoresModels>>> GetListaEvaluacionIndicadoresByEvaluacionId(int EvaluacionId)
        {
            GetResponse<List<JOINTbl_com_ResultadosEvaIndicadoresModels>> resultado = new GetResponse<List<JOINTbl_com_ResultadosEvaIndicadoresModels>>();
            try
            {
                resultado.Data = await _resultadosEvaIndicadoresService.GetListaEvaluacionIndicadoresByEvaluacionId(EvaluacionId);
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
            }
