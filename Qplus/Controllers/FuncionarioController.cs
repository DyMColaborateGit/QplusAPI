...
namespace Qplus.Controllers
{
    ...
    public class FuncionarioController : ControllerBase
    {
        ...
        [HttpGet("GetObjFuncionarioByIdentificacion/{Identificacion}")]
        public async Task<GetResponse<SCP_FuncionariosModels>> GetObjFuncionarioByIdentificacion(long Identificacion)
        {
            GetResponse<SCP_FuncionariosModels> resultado = new GetResponse<SCP_FuncionariosModels>();
            try
            {
                resultado.Data = await _funcionariosService.GetObjFuncionarioByIdentificacion(Identificacion);
        ...
        public async Task<GetResponse<List<SCP_FuncionariosModels>>> GetListfuncionariosByEmpresaIdByEstado(int EmpresaId, bool Estado)
        {
            ...
            try
            {
                resultado.Data = await _funcionariosService.GetListfuncionariosByEmpresaIdByEstado(EmpresaId, Estado);
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
            }
