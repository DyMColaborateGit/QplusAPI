...
namespace Qplus.Controllers
{
    ...
    public class ConsecuenciasController : Controller
    {
        ...
        [HttpGet("GetListaConsecuencias")]
        public async Task<GetResponse<List<Tbl_rgp_ConsecuenciasModels>>> GetListaConsecuencias()
        {
            GetResponse<List<Tbl_rgp_ConsecuenciasModels>> resultado = new GetResponse<List<Tbl_rgp_ConsecuenciasModels>>();
            try
            {
                resultado.Data = await _consecuenciasService.GetListaConsecuencias();
