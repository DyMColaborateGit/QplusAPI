...
namespace Qplus.Controllers
{
    ...
    [ApiController]
    public class ProbabilidadesController
    {
        private readonly IProbabilidadesService _probabilidadesService;

        public ProbabilidadesController(IProbabilidadesService probabilidadesService)
        {
            _probabilidadesService = probabilidadesService;
        }
