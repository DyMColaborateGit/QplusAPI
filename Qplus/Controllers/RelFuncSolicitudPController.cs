...
namespace Qplus.Controllers
{
    ...
    public class RelFuncSolicitudPController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpGet("GetListaRelFuncSolicitudPBySolicitudId/{SolicitudId}")]
        public async Task<GetResponse<List<Tbl_ghu_RelFuncSolicitudPModels>>> GetListaRelFuncSolicitudPBySolicitudId(int SolicitudId)
        {
            GetResponse<List<Tbl_ghu_RelFuncSolicitudPModels>> resultado = new GetResponse<List<Tbl_ghu_RelFuncSolicitudPModels>>();
            try
            {
                resultado.Data = await _relFuncSolicitudPService.GetListaRelFuncSolicitudPBySolicitudId(SolicitudId);
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
            }
