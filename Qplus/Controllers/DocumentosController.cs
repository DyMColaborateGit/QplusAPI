...
namespace Qplus.Controllers
{
    ...
    public class DocumentosController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpPut("PutArchivoEliminadoApp/{DocumentoId}/{ArchivoEliminadoApp}")]
        public async Task<GetResponse<string>> PutArchivoEliminadoApp(int DocumentoId, bool ArchivoEliminadoApp)
        {
            GetResponse<string> resultado = new GetResponse<string>();
            try
            {
                resultado.Data = await _documentosControladosService.PutArchivoEliminadoApp(DocumentoId, ArchivoEliminadoApp);
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
            }
