...
namespace Qplus.Controllers
{
    ...
    public class ActividadesPIDController : ControllerBase
    {
        ...
        [HttpGet("GetObjActividadesPDI/{EmpresaId}")]
        public async Task<GetResponse<TBL_com_ActividadesPIDModels>> GetObjActividadesPDI(int EmpresaId)
        {
            GetResponse<TBL_com_ActividadesPIDModels> resultado = new GetResponse<TBL_com_ActividadesPIDModels>();
            try
            {
                resultado.Data = await _actividadesPIDService.GetObjActividadesPDI(EmpresaId);
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpGet("GetListaActividadesPDI/{EmpresaId}")]
        public async Task<GetResponse<List<TBL_com_ActividadesPIDModels>>> GetListaActividadesPDI(int EmpresaId)
        {
            GetResponse<List<TBL_com_ActividadesPIDModels>> resultado = new GetResponse<List<TBL_com_ActividadesPIDModels>>();
            try
            {
                resultado.Data = await _actividadesPIDService.GetListaActividadesPDI(EmpresaId);
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
            }
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpGet("GetListaActividadesPDIByEvaluadoIdByAnio/{EmpresaId}/{EvaluadoId}/{InAnio}")]
        public async Task<GetResponse<List<TBL_com_ActividadesPIDModels>>> GetListaActividadesPDIByEvaluadoIdByAnio(int EmpresaId, long EvaluadoId, int InAnio)
        {
            GetResponse<List<TBL_com_ActividadesPIDModels>> resultado = new GetResponse<List<TBL_com_ActividadesPIDModels>>();
            try
            {
                resultado.Data = await _actividadesPIDService.GetListaActividadesPDIByEvaluadoIdByAnio(EmpresaId, EvaluadoId, InAnio);
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
            }
