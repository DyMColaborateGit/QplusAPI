...
namespace Qplus.Controllers
{
    ...
    public class TiposActividadController : ControllerBase
    {
        ...
        [HttpGet("GetDataTiposActividadById/{InIdTipoActividad}")]
        public async Task<GetResponse<TBL_com_TiposActividadModels>> GetDataTiposActividadById(int InIdTipoActividad)
        {
            GetResponse<TBL_com_TiposActividadModels> resultado = new GetResponse<TBL_com_TiposActividadModels>();
            try
            {
                resultado.Data = await _tiposActividadService.GetDataTiposActividadById(InIdTipoActividad);
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpGet("GetLisTiposActividadesByEmpresaId/{EmpresaId}/")]
        public async Task<GetResponse<List<TBL_com_TiposActividadModels>>> GetLisTiposActividadesByEmpresaId(int EmpresaId)
        {
            GetResponse<List<TBL_com_TiposActividadModels>> resultado = new GetResponse<List<TBL_com_TiposActividadModels>>();
            try
            {
                resultado.Data = await _tiposActividadService.GetLisTiposActividadesByEmpresaId(EmpresaId);
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
            }
