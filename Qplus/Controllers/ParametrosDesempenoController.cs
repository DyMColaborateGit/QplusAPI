...
namespace Qplus.Controllers
{
    ...
    public class ParametrosDesempenoController : ControllerBase
    {
        ...
        [HttpGet("GetDataParametroDesempenoByMaxValor/{TipoId}")]
        public async Task<GetResponse<TBL_com_ParametrosDesempenoModels>> GetDataParametroDesempenoByMaxValor(int TipoId)
        {
            GetResponse<TBL_com_ParametrosDesempenoModels> resultado = new GetResponse<TBL_com_ParametrosDesempenoModels>();
            try
            {
                resultado.Data = await _parametrosDesempenoService.GetDataParametroDesempenoByMaxValor(TipoId);
